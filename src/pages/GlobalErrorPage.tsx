...
export const GlobalErrorPage: React.FC<GlobalErrorPageProps> = ({ error, resetErrorBoundary }) => {
  return (
    <div className="min-h-screen flex items-center justify-center p-6 bg-secondary text-center text-gray-900 dark:text-gray-100">
        ...
        <div className="flex flex-col sm:flex-row gap-3 justify-center pt-2">
          {resetErrorBoundary && (
            <button
              ...
              className="bg-indigo-600 hover:bg-indigo-700 text-white font-bold text-xs py-3 px-6 rounded-xl cursor-pointer shadow transition-all hover:scale-105 active:scale-95 flex items-center justify-center gap-2"
            >
          ...
          <a
            href={ROUTES.HOME}
            className="bg-gray-150 dark:bg-slate-800 text-gray-700 dark:text-gray-200 hover:bg-gray-200 dark:hover:bg-slate-700 font-bold text-xs py-3 px-6 rounded-xl cursor-pointer transition-all hover:scale-105 active:scale-95 flex items-center justify-center gap-2"
          >
